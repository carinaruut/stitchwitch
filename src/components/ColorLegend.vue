      ...
      >
        ...
        >
          ...
          <details
            ...
            :class="editable ? 'dropdown w-full' : ''"
          ...
          >
            ...
            <div
              class="gap-3"
              :class="editable
                ? 'dropdown-content inset-x-0 z-[1000] mt-1 flex w-full min-w-0 flex-col rounded-box border border-base-300 bg-base-100 p-4 shadow-xl'
                : 'grid border-t border-base-300 px-3 py-3 sm:grid-cols-2'"
            >
