...
import { createDefaultProject, createPattern, type PatternState } from '../../editor/composables/usePattern'
import { useTracker, type TrackerController } from '../../tracker/composables/useTracker'
